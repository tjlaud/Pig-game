...
document.querySelector(".btn-roll").addEventListener("click", function () {
    ...
    if (dice !== 1 && dice2 !== 1) {               // !== means different than
        //add score
        roundScore += diceResult;         // this is the same as writing roundScore = roundScore + dice
...
document.querySelector(".btn-hold").addEventListener("click", function () {
    ...
    scores[activePlayer] >= winningScore ? endGame() : nextplayer();
}
});
